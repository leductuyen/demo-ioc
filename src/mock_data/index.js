...
export const ESelectSynchronouStype_MockData = [
    {
        tenLoaiDongBo: 'Sửa học sinh theo lô',
        value: 1
    },
    {
        tenLoaiDongBo: 'Sửa giáo viên theo lô',
        value: 2
    },
    {
        tenLoaiDongBo: 'Đẩy thông tin đầu năm',
        value: 3
    },
    {
        tenLoaiDongBo: 'Đẩy học sinh biến động',
        value: 4
    },
    {
        tenLoaiDongBo: 'Đẩy thông tin điểm',
        value: 5
    },
    {
        tenLoaiDongBo: 'Đẩy thông tin cuối năm',
        value: 6
    },
    {
        tenLoaiDongBo: 'Đẩy dữ liệu đầu năm *',
        value: 7
    },
    {
        tenLoaiDongBo: 'Đẩy dữ liệu EQMS giữa năm',
        value: 8
    }
] // loại đồng bộ
...
export const permission_ioc = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                checked: true,
                name: 'Học sinh biến động',
                path: '/student-fluctuating',
                icon: 'el-icon-user'
            },
            {
                checked: true,
                name: 'Kết quả học tập của học sinh',
...
export const mockData_BieuDoDashedLineChart = {
    loaiHinhTruong: {
        series: [
            {
            ...
            {
                name: 'Dân lập',
                data: [85000, 65300, 70496, 87620, 98963, 108990, 119120]
            },
            {
                name: 'Tư thục',
                data: [36000, 48400, 58543, 68213, 66880, 75185, 96305]
            }
        ],
        categories: [
            '2018-2019',
...
export const xaxisCategories_TongQuanChung = {
